...
import { Download, ExternalLink, RefreshCw, FileText, User, Briefcase, Calendar, Mail, MapPin, Phone } from "lucide-react";
...
const OutputPreview = ({
  ...
  // Create display data from extracted information
  const displayData = [
    { icon: User, label: "Name", value: extractedData?.name || "Not extracted" },
    { icon: Mail, label: "Email", value: extractedData?.email || "Not extracted" },
    { icon: Phone, label: "Phone", value: extractedData?.phone || "Not extracted" },
    { icon: Briefcase, label: "Experience", value: extractedData?.experience ? (extractedData.experience.length > 50 ? extractedData.experience.substring(0, 50) + "..." : extractedData.experience) : "Not extracted" },
    { icon: Calendar, label: "Skills", value: extractedData?.skills ? (extractedData.skills.length > 50 ? extractedData.skills.substring(0, 50) + "..." : extractedData.skills) : "Not extracted" },
  ];
          ...
          {extractedData?.summary && (
            <div className="mt-6 pt-4 border-t border-border">
              ...
              <p className="text-sm text-foreground">
                {extractedData.summary.length > 100 
                  ? extractedData.summary.substring(0, 100) + "..." 
                  : extractedData.summary}
              </p>
            </div>
          )}
